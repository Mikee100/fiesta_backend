...
var DomainExpertiseService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.DomainExpertiseService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../prisma/prisma.service");
let DomainExpertiseService = DomainExpertiseService_1 = class DomainExpertiseService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(DomainExpertiseService_1.name);
    }
    getBestPractices() {
        return {
            optimalWeeks: {
    ...
    async recommendPackages(criteria) {
    ...
    getUpsellSuggestions(currentPackage) {
        const suggestions = [];
    ...
    async answerDomainQuestion(question) {
    ...
    async seedDomainKnowledge() {
        ...
        for (const entry of knowledgeEntries) {
            await this.prisma.domainKnowledge.upsert({
                ...
                return this.prisma.domainKnowledge.create({ data: entry });
            });
        }
        this.logger.log(`Seeded ${knowledgeEntries.length} domain knowledge entries`);
    }
};
exports.DomainExpertiseService = DomainExpertiseService;
exports.DomainExpertiseService = DomainExpertiseService = DomainExpertiseService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], DomainExpertiseService);
//# sourceMappingURL=domain-expertise.service.js.map